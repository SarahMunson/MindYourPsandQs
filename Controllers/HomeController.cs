...
namespace MindYourPsandQs.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult addObjective(int lid, Objective newObjective)
        {
            if(ModelState.IsValid)
            {
                ...
                .FirstOrDefault(p => p.LanguageId == HttpContext.Session.GetInt32("lid"));
                return View("Objectives");
            }
        }
        ...
        public IActionResult addStep(int oid, Step newStep)
        {
            if(ModelState.IsValid)
            {
                ...
                .FirstOrDefault(p => p.ObjectiveId == HttpContext.Session.GetInt32("oid"));
                return View("Steps");
            }
        }
